...
class Assignment2 {
    ...
    public int[] AddFdsMarks() {
        ...
        for (int i=0; i<seStudents.length; i++) {
            ...
            while(!validInput) {
                ...
                String studentName = scanner.next();
                for (int j=0; j<seStudents.length; j++) {
                    if(seStudents[j].equals(studentName)) {
                        validInput = true;
                        studentIndex = j;
                        break;
                    }
                ...
                if(!validInput) {
                    System.out.println("Student name not found. Please enter a valid student name.");
                }
            }
            System.out.println("Enter FDS marks of student "+(seStudents[studentIndex])+":");
            int mark = scanner.nextInt();
            this.fdsMarks[studentIndex] = mark;
        }
