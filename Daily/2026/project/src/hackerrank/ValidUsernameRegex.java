...
//            }
//        }
        BufferedReader inputReader = new BufferedReader(new FileReader("D:\\Github\\Learning\\Daily\\2026\\project\\resources\\username_regex_input.txt"));
        BufferedReader outputReader = new BufferedReader(new FileReader("D:\\Github\\Learning\\Daily\\2026\\project\\resources\\username_regex_output.txt"));
        String inputLine, outputLine;

        while((inputLine = inputReader.readLine()) != null && (outputLine = outputReader.readLine()) != null) {
            boolean input = inputLine.matches(UsernameValidator.regularExpression);
            boolean expectedOutput = outputLine.equals("Invalid") ? false : true;
