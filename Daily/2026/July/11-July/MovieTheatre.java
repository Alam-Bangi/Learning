...
class MovieTheatre {
    ...
    public static void main(String[] args) {
        ...
        movieCatalog.put(03, new Movie("Saiyara", "Drama", 134));
        movieCatalog.put(02, new Movie("Khichdi", "Comedy", 120));
        movieCatalog.put(01, new Movie("Raees", "Action", 112));
        ...
        bookings.add(new Ticket("Alice", movieCatalog.get(01), "2026-10-07 18:00"));
        bookings.add(new Ticket("Bob", movieCatalog.get(02), "2026-11-07 20:00"));
        bookings.add(new Ticket("John", movieCatalog.get(03), "2026-19-07 14:00"));

        for (Ticket ticket : bookings) {
            System.out.println(ticket);
        }

        System.out.println("\nDetails of Movie ID 03:");
