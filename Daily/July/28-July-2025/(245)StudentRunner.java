...
class StudentRunner {
    public static void main(String[] args) {
        Student student = new Student ("Alice", new int[]{97,98,100});
        Student student2 = new Student ("Bob", new int[]{97,98});
        Student student3 = new Student ("Charlie", new int[]{97,98,90,98});
